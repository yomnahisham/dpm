...
optional<string> BacktrackResolver::selectUnassignedPackage_MRV(const ResolutionState& state, const DependencyGraph& graph, const vector<shared_ptr<Source>>& sources) {
    string best_package;
...
vector<string> BacktrackResolver::getOrderedVersions(const string& package, const vector<shared_ptr<Source>>& sources, const ResolutionState& state) {
    // Find source
    shared_ptr<Source> source = nullptr;
    for (const auto& s : sources) {
...
bool BacktrackResolver::forwardCheck(const string& package,const string& version, const ResolutionState& state, const DependencyGraph& graph, const vector<shared_ptr<Source>>& sources) {
...
void BacktrackResolver::propagateConstraints(const string& package, const string& version, ResolutionState& state, const DependencyGraph& graph) {
